...
template <class _Tp>
struct __is_hash_value_type_imp : std::false_type {};

template <class _Key, class _Value>
struct __is_hash_value_type_imp<__hash_value_type<_Key, _Value>> : true_type {};

template <class... _Args>
struct __is_hash_value_type : std::false_type {};
...
struct __hash_node_base {
...
#else
    typedef typename conditional<is_pointer<__node_pointer>::value, __node_base_pointer, __node_pointer>::type
        __next_pointer;
#endif
    ...
    __next_pointer __ptr() {
        return static_cast<__next_pointer>(std::pointer_traits<__node_base_pointer>::pointer_to(*this));
    }

    __node_pointer __upcast() {
        return static_cast<__node_pointer>(std::pointer_traits<__node_base_pointer>::pointer_to(*this));
    }
...
struct __hash_node : public __hash_node_base<typename __rebind_pointer<_VoidPtr, __hash_node<_Tp, _VoidPtr>>::type> {
...
inline bool __is_hash_power2(size_t __bc) {
    return __bc > 2 && !(__bc & (__bc - 1));
}

inline size_t __constrain_hash(size_t __h, size_t __bc) {
    return !(__bc & (__bc - 1)) ? __h & (__bc - 1) : (__h < __bc ? __h : __h % __bc);
}

inline size_t __next_hash_pow2(size_t __n) {
...
struct __hash_key_value_types<__hash_value_type<_Key, _Tp>> {
    ...
    template <class _Up>
    static typename enable_if<__is_same_uncvref<_Up, __node_value_type>::value, __container_value_type const&>::type
    __get_value(_Up& __t) {
    ...
    template <class _Up>
    static
        typename enable_if<__is_same_uncvref<_Up, __container_value_type>::value, __container_value_type const&>::type
        __get_value(_Up& __t) {
        return __t;
    }
...
struct __hash_node_types<_NodePtr, __hash_node<_Tp, _VoidPtr>> : public __hash_key_value_types<_Tp>,
...

{
  ...
  private:
    ...
    static_assert((is_same<typename std::pointer_traits<_VoidPtr>::element_type, void>::value),
                  "_VoidPtr does not point to unqualified void type");
    static_assert((is_same<typename __rebind_pointer<_VoidPtr, __node_type>::type, _NodePtr>::value),
...
class _LIBCPP_TEMPLATE_VIS __hash_iterator {
  ...
  public:
    ...
    __hash_iterator() : __node_(nullptr) {
        _LIBCPP_DEBUG_MODE(__get_db()->__insert_i(this));
    }

#if _LIBCPP_DEBUG_LEVEL >= 2

    __hash_iterator(const __hash_iterator& __i) : __node_(__i.__node_) {
    ...
    pointer operator->() const {
        _LIBCPP_DEBUG_ASSERT(__get_const_db()->__dereferenceable(this),
                             "Attempted to dereference a non-dereferenceable unordered container iterator");
        return std::pointer_traits<pointer>::pointer_to(__node_->__upcast()->__value_);
    }
  ...
  private:
    ...
    __hash_iterator(__next_pointer __node, const void* __c) : __node_(__node) {
        __get_db()->__insert_ic(this, __c);
    }
#else

    __hash_iterator(__next_pointer __node) : __node_(__node) {
    }
#endif
...
template <class _NodePtr>
class _LIBCPP_TEMPLATE_VIS __hash_const_iterator {
    static_assert(!is_const<typename std::pointer_traits<_NodePtr>::element_type>::value, "");
    typedef __hash_node_types<_NodePtr> _NodeTypes;
    typedef _NodePtr __node_pointer;
    typedef typename _NodeTypes::__next_pointer __next_pointer;
  ...
  public:
    ...
    __hash_const_iterator() : __node_(nullptr) {
        _LIBCPP_DEBUG_MODE(__get_db()->__insert_i(this));
    }

    __hash_const_iterator(const __non_const_iterator& __x) : __node_(__x.__node_) {
        _LIBCPP_DEBUG_MODE(__get_db()->__iterator_copy(this, &__x));
    }

#if _LIBCPP_DEBUG_LEVEL >= 2

    __hash_const_iterator(const __hash_const_iterator& __i) : __node_(__i.__node_) {
        __get_db()->__iterator_copy(this, &__i);
    }
  ...
  private:
    ...
    __hash_const_iterator(__next_pointer __node, const void* __c) : __node_(__node) {
        __get_db()->__insert_ic(this, __c);
    }
#else

    __hash_const_iterator(__next_pointer __node) : __node_(__node) {
    }
#endif
    template <class, class, class, class>
    friend class __hash_table;
...
class _LIBCPP_TEMPLATE_VIS __hash_local_iterator {
  ...
  public:
    ...
    __hash_local_iterator() : __node_(nullptr) {
        _LIBCPP_DEBUG_MODE(__get_db()->__insert_i(this));
    }
    ...
    __hash_local_iterator(const __hash_local_iterator& __i)
        : __node_(__i.__node_), __bucket_(__i.__bucket_), __bucket_count_(__i.__bucket_count_) {
        __get_db()->__iterator_copy(this, &__i);
    }
  ...
  private:
    ...
    __hash_local_iterator(__next_pointer __node, size_t __bucket, size_t __bucket_count, const void* __c)
    ...
    __hash_local_iterator(__next_pointer __node, size_t __bucket, size_t __bucket_count)
        : __node_(__node), __bucket_(__bucket), __bucket_count_(__bucket_count) {
        if (__node_ != nullptr)
            __node_ = __node_->__next_;
    }
...
class _LIBCPP_TEMPLATE_VIS __hash_const_local_iterator {
    ...
    typedef std::pointer_traits<__node_pointer> __std::pointer_traits;
    typedef typename __std::pointer_traits::element_type __node;
  ...
  public:
    ...
    __hash_const_local_iterator() : __node_(nullptr) {
        _LIBCPP_DEBUG_MODE(__get_db()->__insert_i(this));
    }

    __hash_const_local_iterator(const __non_const_iterator& __x)
        : __node_(__x.__node_), __bucket_(__x.__bucket_), __bucket_count_(__x.__bucket_count_) {
        _LIBCPP_DEBUG_MODE(__get_db()->__iterator_copy(this, &__x));
    }
  ...
  private:
    ...
    __hash_const_local_iterator(__next_pointer __node, size_t __bucket, size_t __bucket_count, const void* __c)
        : __node_(__node), __bucket_(__bucket), __bucket_count_(__bucket_count) {
        __get_db()->__insert_ic(this, __c);
        if (__node_ != nullptr)
            __node_ = __node_->__next_;
    ...
    __hash_const_local_iterator(__next_pointer __node, size_t __bucket, size_t __bucket_count)
        : __node_(__node), __bucket_(__bucket), __bucket_count_(__bucket_count) {
        if (__node_ != nullptr)
            __node_ = __node_->__next_;
    }
...
class __bucket_list_deallocator {
  ...
  public:
    ...
    __bucket_list_deallocator() _(is_nothrow_default_constructible<allocator_type>::value) : __data_(0) {
    }
    ...
    __bucket_list_deallocator(__bucket_list_deallocator&& __x) _(is_nothrow_move_constructible<allocator_type>::value)
...
class __hash_node_destructor {
  ...
  public:
    ...
    explicit __hash_node_destructor(allocator_type& __na, bool __constructed = false)
        : __na_(__na), __value_constructed(__constructed) {
    }
...
class __hash_table {
  ...
  private:
    ...
    // the pointer using 'std::pointer_traits'.
  ...
  public:
    ...
    __hash_table() _(
        is_nothrow_default_constructible<__bucket_list>::value&& is_nothrow_default_constructible<__first_node>::value&&
            is_nothrow_default_constructible<__node_allocator>::value&&
                is_nothrow_default_constructible<hasher>::value&& is_nothrow_default_constructible<key_equal>::value);
    ...
    __hash_table(__hash_table&& __u)
        _(is_nothrow_move_constructible<__bucket_list>::value&& is_nothrow_move_constructible<__first_node>::value&&
    ...
    __hash_table& operator=(__hash_table&& __u)
        _(__node_traits::propagate_on_container_move_assignment::value&&
  ...
  private:
    __next_pointer __node_insert_multi_prepare(size_t __cp_hash, value_type& __cp_val);

    void __node_insert_multi_perform(__node_pointer __cp, __next_pointer __pn);

    __next_pointer __node_insert_unique_prepare(size_t __nd_hash, value_type& __nd_val);

    void __node_insert_unique_perform(__node_pointer __ptr);
  ...
  public:
    ...
    typename enable_if<__can_extract_map_key<_First, key_type, __container_value_type>::value,
    ...
    template <class _Pp>
    pair<iterator, bool> __emplace_unique_extract_key(_Pp&& __x, __extract_key_fail_tag) {
    ...
    template <class _Pp>
    pair<iterator, bool> __emplace_unique_extract_key(_Pp&& __x, __extract_key_first_tag) {
    ...
    template <class _Pp, class = typename enable_if<!__is_same_uncvref<_Pp, __container_value_type>::value>::type>
    ...
    iterator __node_handle_insert_unique(const_iterator __hint, _NodeHandle&& __nh);
    ...
    template <class _Key>
    pair<const_iterator, const_iterator> __equal_range_multi(const _Key& __k) const;

    void swap(__hash_table& __u)
#if _LIBCPP_STD_VER <= 11
        _DEBUG_(__is_nothrow_swappable<hasher>::value&& __is_nothrow_swappable<key_equal>::value &&
    ...
    void max_load_factor(float __mlf) {
        _LIBCPP_ASSERT(__mlf > 0, "unordered container::max_load_factor(lf) called with lf <= 0");
        max_load_factor() = _VSTD::max(__mlf, load_factor());
    }

    local_iterator begin(size_type __n) {
        _LIBCPP_ASSERT(__n < bucket_count(), "unordered container::begin(n) called with n >= bucket_count()");
#if _LIBCPP_DEBUG_LEVEL >= 2
    ...
    const_local_iterator cbegin(size_type __n) const {
        _LIBCPP_ASSERT(__n < bucket_count(), "unordered container::cbegin(n) called with n >= bucket_count()");
#if _LIBCPP_DEBUG_LEVEL >= 2
    ...
    const_local_iterator cend(size_type __n) const {
        _LIBCPP_ASSERT(__n < bucket_count(), "unordered container::cend(n) called with n >= bucket_count()");
#if _LIBCPP_DEBUG_LEVEL >= 2
  ...
  private:
    ...
    void __copy_assign_alloc(const __hash_table& __u) {
        __copy_assign_alloc(__u,
                            integral_constant<bool, __node_traits::propagate_on_container_copy_assignment::value>());
    }
    ...
    void __move_assign(__hash_table& __u, true_type)
        _(is_nothrow_move_assignable<__node_allocator>::value&& is_nothrow_move_assignable<hasher>::value&&
              is_nothrow_move_assignable<key_equal>::value);

    void __move_assign_alloc(__hash_table& __u) _(!__node_traits::propagate_on_container_move_assignment::value ||
                                                  (is_nothrow_move_assignable<__pointer_allocator>::value &&
                                                   is_nothrow_move_assignable<__node_allocator>::value)) {
        __move_assign_alloc(__u,
                            integral_constant<bool, __node_traits::propagate_on_container_move_assignment::value>());
    }

    void __move_assign_alloc(__hash_table& __u, true_type) _(
        is_nothrow_move_assignable<__pointer_allocator>::value&& is_nothrow_move_assignable<__node_allocator>::value) {
        __bucket_list_.get_deleter().__alloc() = _VSTD::move(__u.__bucket_list_.get_deleter().__alloc());
        __node_alloc() = _VSTD::move(__u.__node_alloc());
    }

    void __move_assign_alloc(__hash_table&, std::false_type) {
    }
#endif  // _LIBCPP_CXX03_LANG

    void __deallocate_node(__next_pointer __np);
...
inline __hash_table<_Tp, _Hash, _Equal, _Alloc>::__hash_table()
    _(is_nothrow_default_constructible<__bucket_list>::value&& is_nothrow_default_constructible<__first_node>::value&&
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
__hash_table<_Tp, _Hash, _Equal, _Alloc>::__hash_table(const hasher& __hf, const key_equal& __eql,
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
void __hash_table<_Tp, _Hash, _Equal, _Alloc>::__deallocate_node(__next_pointer __np) {
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
typename __hash_table<_Tp, _Hash, _Equal, _Alloc>::__next_pointer __hash_table<_Tp, _Hash, _Equal, _Alloc>::__detach() {
    size_type __bc = bucket_count();
    for (size_type __i = 0; __i < __bc; ++__i) __bucket_list_[__i] = nullptr;
    size() = 0;
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
void __hash_table<_Tp, _Hash, _Equal, _Alloc>::__move_assign(__hash_table& __u, std::false_type) {
    if (__node_alloc() == __u.__node_alloc())
...
void __hash_table<_Tp, _Hash, _Equal, _Alloc>::__assign_unique(_InputIterator __first, _InputIterator __last) {
    ...
    for (; __first != __last; ++__first) __insert_unique(*__first);
}
...
void __hash_table<_Tp, _Hash, _Equal, _Alloc>::__assign_multi(_InputIterator __first, _InputIterator __last) {
    ...
    for (; __first != __last; ++__first) __insert_multi(_NodeTypes::__get_value(*__first));
}

template <class _Tp, class _Hash, class _Equal, class _Alloc>
inline typename __hash_table<_Tp, _Hash, _Equal, _Alloc>::iterator __hash_table<_Tp, _Hash, _Equal, _Alloc>::begin() {
#if _LIBCPP_DEBUG_LEVEL >= 2
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
inline typename __hash_table<_Tp, _Hash, _Equal, _Alloc>::iterator __hash_table<_Tp, _Hash, _Equal, _Alloc>::end() {
#if _LIBCPP_DEBUG_LEVEL >= 2
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
inline typename __hash_table<_Tp, _Hash, _Equal, _Alloc>::const_iterator __hash_table<_Tp, _Hash, _Equal, _Alloc>::end()
    const {
#if _LIBCPP_DEBUG_LEVEL >= 2
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
void __hash_table<_Tp, _Hash, _Equal, _Alloc>::clear() {
    if (size() > 0) {
        __deallocate_node(__p1_.first().__next_);
        __p1_.first().__next_ = nullptr;
        size_type __bc = bucket_count();
...
// in the map.
template <class _Tp, class _Hash, class _Equal, class _Alloc>
void __hash_table<_Tp, _Hash, _Equal, _Alloc>::__node_insert_unique_perform(__node_pointer __nd) {
    size_type __bc = bucket_count();
...
__hash_table<_Tp, _Hash, _Equal, _Alloc>::__node_insert_unique(__node_pointer __nd) {
    ...
    __next_pointer __existing_node = __node_insert_unique_prepare(__nd->__hash(), __nd->__value_);
...
__hash_table<_Tp, _Hash, _Equal, _Alloc>::__node_insert_multi_prepare(size_t __cp_hash, value_type& __cp_val) {
    ...
    if (__pn != nullptr) {
        for (bool __found = false;
            ...
            //      true        false       break
            if (__found !=
                (__pn->__next_->__hash() == __cp_hash && key_eq()(__pn->__next_->__upcast()->__value_, __cp_val))) {
                if (!__found)
                    __found = true;
                else
                    break;
...
// is up-to-date.
template <class _Tp, class _Hash, class _Equal, class _Alloc>
void __hash_table<_Tp, _Hash, _Equal, _Alloc>::__node_insert_multi_perform(__node_pointer __cp, __next_pointer __pn) {
    size_type __bc = bucket_count();
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
template <class... _Args>
typename __hash_table<_Tp, _Hash, _Equal, _Alloc>::iterator __hash_table<_Tp, _Hash, _Equal, _Alloc>::__emplace_multi(
    _Args&&... __args) {
    __node_holder __h = __construct_node(_VSTD::forward<_Args>(__args)...);
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
typename __hash_table<_Tp, _Hash, _Equal, _Alloc>::iterator __hash_table<_Tp, _Hash, _Equal, _Alloc>::__insert_multi(
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
typename __hash_table<_Tp, _Hash, _Equal, _Alloc>::iterator __hash_table<_Tp, _Hash, _Equal, _Alloc>::__insert_multi(
    const_iterator __p, const __container_value_type& __x) {
#    if _LIBCPP_DEBUG_LEVEL >= 2
    _LIBCPP_ASSERT(__get_const_db()->__find_c_from_i(&__p) == this,
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
template <class _NodeHandle, class _InsertReturnType>
_InsertReturnType __hash_table<_Tp, _Hash, _Equal, _Alloc>::__node_handle_insert_unique(_NodeHandle&& __nh) {
    if (__nh.empty())
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
template <class _NodeHandle>
_NodeHandle __hash_table<_Tp, _Hash, _Equal, _Alloc>::__node_handle_extract(key_type const& __key) {
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
template <class _NodeHandle>
_NodeHandle __hash_table<_Tp, _Hash, _Equal, _Alloc>::__node_handle_extract(const_iterator __p) {
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
template <class _Table>
void __hash_table<_Tp, _Hash, _Equal, _Alloc>::__node_handle_merge_unique(_Table& __source) {
    ...
    for (typename _Table::iterator __it = __source.begin(); __it != __source.end();) {
        ...
        __next_pointer __existing_node = __node_insert_unique_prepare(__hash, __src_ptr->__value_);
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
template <class _Table>
void __hash_table<_Tp, _Hash, _Equal, _Alloc>::__node_handle_merge_multi(_Table& __source) {
    static_assert(is_same<typename _Table::__node, __node>::value, "");

    for (typename _Table::iterator __it = __source.begin(); __it != __source.end();) {
        __node_pointer __src_ptr = __it.__node_->__upcast();
        size_t __src_hash = hash_function()(__src_ptr->__value_);
        __next_pointer __pn = __node_insert_multi_prepare(__src_hash, __src_ptr->__value_);
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
void __hash_table<_Tp, _Hash, _Equal, _Alloc>::rehash(size_type __n) {
    if (__n == 1)
        __n = 2;
    else if (__n & (__n - 1))
    ...
    if (__n > __bc)
        ...
        __n = _VSTD::max<size_type>(__n, __is_hash_power2(__bc)
                                             ? __next_hash_pow2(size_t(ceil(float(size()) / max_load_factor())))
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
void __hash_table<_Tp, _Hash, _Equal, _Alloc>::__rehash(size_type __nbc) {
#if _LIBCPP_DEBUG_LEVEL >= 2
    ...
    if (__nbc > 0) {
        for (size_type __i = 0; __i < __nbc; ++__i) __bucket_list_[__i] = nullptr;
        ...
        if (__cp != nullptr) {
            ...
            for (__pp = __cp, __cp = __cp->__next_; __cp != nullptr; __cp = __pp->__next_) {
                ...
                if (__chash == __phash)
                    ...
                    if (__bucket_list_[__chash] == nullptr) {
                        ...
                        for (; __np->__next_ != nullptr &&
                               key_eq()(__cp->__upcast()->__value_, __np->__next_->__upcast()->__value_);
                             __np = __np->__next_)
                            ;
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
template <class _Key>
typename __hash_table<_Tp, _Hash, _Equal, _Alloc>::iterator __hash_table<_Tp, _Hash, _Equal, _Alloc>::find(
    const _Key& __k) {
    size_t __hash = hash_function()(__k);
    size_type __bc = bucket_count();
    if (__bc != 0) {
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
template <class _Key>
typename __hash_table<_Tp, _Hash, _Equal, _Alloc>::const_iterator __hash_table<_Tp, _Hash, _Equal, _Alloc>::find(
...
__hash_table<_Tp, _Hash, _Equal, _Alloc>::__construct_node_hash(size_t __hash, _First&& __f, _Rest&&... __rest) {
    ...
    __node_allocator& __na = __node_alloc();
    __node_holder __h(__node_traits::allocate(__na, 1), _Dp(__na));
    __node_traits::construct(__na, _NodeTypes::__get_ptr(__h->__value_), _VSTD::forward<_First>(__f),
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
typename __hash_table<_Tp, _Hash, _Equal, _Alloc>::__node_holder
__hash_table<_Tp, _Hash, _Equal, _Alloc>::__construct_node_hash(size_t __hash, const __container_value_type& __v) {
    __node_allocator& __na = __node_alloc();
    __node_holder __h(__node_traits::allocate(__na, 1), _Dp(__na));
    __node_traits::construct(__na, _NodeTypes::__get_ptr(__h->__value_), __v);
    __h.get_deleter().__value_constructed = true;
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
typename __hash_table<_Tp, _Hash, _Equal, _Alloc>::iterator __hash_table<_Tp, _Hash, _Equal, _Alloc>::erase(
    const_iterator __p) {
    __next_pointer __np = __p.__node_;
#if _LIBCPP_DEBUG_LEVEL >= 2
    _LIBCPP_ASSERT(__get_const_db()->__find_c_from_i(&__p) == this,
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
template <class _Key>
typename __hash_table<_Tp, _Hash, _Equal, _Alloc>::size_type __hash_table<_Tp, _Hash, _Equal, _Alloc>::__erase_unique(
    const _Key& __k) {
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
template <class _Key>
typename __hash_table<_Tp, _Hash, _Equal, _Alloc>::size_type __hash_table<_Tp, _Hash, _Equal, _Alloc>::__erase_multi(
    const _Key& __k) {
    size_type __r = 0;
    iterator __i = find(__k);
    if (__i != end()) {
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
typename __hash_table<_Tp, _Hash, _Equal, _Alloc>::__node_holder __hash_table<_Tp, _Hash, _Equal, _Alloc>::remove(
    const_iterator __p) {
    // current node
    ...
    if (__pn == __p1_.first().__ptr() || __constrain_hash(__pn->__hash(), __bc) != __chash) {
        if (__cn->__next_ == nullptr || __constrain_hash(__cn->__next_->__hash(), __bc) != __chash)
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
template <class _Key>
typename __hash_table<_Tp, _Hash, _Equal, _Alloc>::size_type __hash_table<_Tp, _Hash, _Equal, _Alloc>::__count_multi(
    const _Key& __k) const {
    size_type __r = 0;
...
#endif
{
    _LIBCPP_ASSERT(__node_traits::propagate_on_container_swap::value || this->__node_alloc() == __u.__node_alloc(),
    ...
    __swap_allocator(__bucket_list_.get_deleter().__alloc(), __u.__bucket_list_.get_deleter().__alloc());
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
typename __hash_table<_Tp, _Hash, _Equal, _Alloc>::size_type __hash_table<_Tp, _Hash, _Equal, _Alloc>::bucket_size(
    size_type __n) const {
    ...
    size_type __r = 0;
    if (__np != nullptr) {
        for (__np = __np->__next_; __np != nullptr && __constrain_hash(__np->__hash(), __bc) == __n;
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
inline void swap(__hash_table<_Tp, _Hash, _Equal, _Alloc>& __x, __hash_table<_Tp, _Hash, _Equal, _Alloc>& __y)
    _(_(__x.swap(__y))) {
    __x.swap(__y);
}
...
template <class _Tp, class _Hash, class _Equal, class _Alloc>
bool __hash_table<_Tp, _Hash, _Equal, _Alloc>::__dereferenceable(const const_iterator* __i) const {
    return __i->__node_ != nullptr;
}

template <class _Tp, class _Hash, class _Equal, class _Alloc>
bool __hash_table<_Tp, _Hash, _Equal, _Alloc>::__decrementable(const const_iterator*) const {
    return false;
}

template <class _Tp, class _Hash, class _Equal, class _Alloc>
bool __hash_table<_Tp, _Hash, _Equal, _Alloc>::__addable(const const_iterator*, ptrdiff_t) const {
    return false;
}

template <class _Tp, class _Hash, class _Equal, class _Alloc>
bool __hash_table<_Tp, _Hash, _Equal, _Alloc>::__subscriptable(const const_iterator*, ptrdiff_t) const {
    return false;
}
